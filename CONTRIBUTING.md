...
This repository is a **fork**: upstream [bnb-chain/bsc](https://github.com/bnb-chain/bsc)
...
a general-purpose fork of bnb-chain/bsc.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v2.8.1-ct.2`); a GitHub Release publishes the versioned images
